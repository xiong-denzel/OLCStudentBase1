# Task 3
# The task is to edit program code so that countries and their 
# capital cities can be added to or removed from a dictionary.

# The following program has a dictionary that contains countries and their capital cities. 
...
#     print(f"The capital city of {country} is {capital_cities[country]}")
# if remove == "Y":
#     removed = input("Enter the country you wish to remove: ")
#     removed = removed.lower()
#     del capital_cities[removed]
...
add = input("Would you like to add a new entry? (Y or N): ")
if add == "Y":
    addc = input("input a country: ")
    addcc = input("input the capital city for the country: ")
    capital_cities[addc] = addcc
    print(capital_cities)
